...
public class ControllabilityNonExecBeat {
	...
	public void a_Test() throws InterruptedException, IOException {
		...
		try {
			...
			System.out.println("############ Response for Test 1: ############");
	...
	@Test
	 public void b_Test() throws InterruptedException {
		System.out.println("############ Running test 2: Droping 0.10% packet: ############");
		...
		obj.addProperty("packetLoss", "0.10");
