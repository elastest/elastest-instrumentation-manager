...
public class PacketLossTests75 {
	...
	public void b_Test() throws InterruptedException, IOException{
	 ...
	 public void c_Test() throws InterruptedException {
		System.out.println("############ Running Test3 TCP 0.75%: ############");
		System.out.println("Inyection: Iptables -A INPUT -m statistic --mode random --probability 0.75 -j DROP");
	 ...
	 public void d_Test() throws InterruptedException, IOException{
			System.out.println("############ Running Test4: Timing for [0.75% packetloss] Max.timing 100ms: ############");
			long start = System.nanoTime();
			headers.setContentType(MediaType.APPLICATION_JSON);
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			try {
				...
				elapesedTimeInMiliSeconds = TimeUnit.MILLISECONDS.convert(elapsedTime, TimeUnit.NANOSECONDS) / 1000.0;
