...
public class MonitoringTestEK {
	private String sut_address = System.getenv("EIM_SUT_SERVICE_HOST");
	...
	private String server = System.getenv("EIM_SERVICE_HOST")+"/agent/";	
	...
	@Test
	 public void d_Test() throws InterruptedException {
		System.out.println("############ Running test 4: CPU stressor: ############");
	...
	@Test
	 ...
	 public void f_Test() throws InterruptedException {
		System.out.println("############ Running Test6 Unmonitoring: ############");
	 ...
	 public void g_Test() throws InterruptedException {
		 ...
		 System.out.println("############ Running Test7 Delete beats: ############");
		 headers.setContentType(MediaType.APPLICATION_JSON);
		 headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
