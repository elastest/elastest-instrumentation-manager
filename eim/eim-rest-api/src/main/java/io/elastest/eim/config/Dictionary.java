...
public class Dictionary {
	...
	public static String PROPERTY_TEMPLATES_SCRIPT_JOKER = "templates.script.joker";
	...
	public static String PROPERTY_TEMPLATES_BEATS_PLAYBOOK = "templates.beats.playbook";
	public static String PROPERTY_TEMPLATES_BEATS_EXECUTION_PLAYBOOK_PREFIX = "templates.beats.execution_playbook_prefix";
